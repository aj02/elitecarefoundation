...
var switcherClass = {
	...
	switchColorScheme: function ( e ) {
	    ...
	    if (color == 2) {
	    	//jQuery(".site-logo").attr("src", "images/logo_dark.png");
	    	jQuery(".site-logo").attr("src", "images/elite_care_foundation_logo.png");
	    } else {
	    	jQuery(".site-logo").attr("src", "images/elite_care_foundation_logo.png");
	    };
	...
	switchDarkLight: function ( e ) {
		...
		if(jQuery(".page_footer").hasClass("footer_dark")) {
			jQuery(".page_footer").removeClass("footer_dark");
		} else {
			jQuery(".page_footer").addClass("footer_dark");
		};
